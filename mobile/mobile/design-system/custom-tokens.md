...
| `--color-switch-overlay` | `rgba(255, 255, 255, 0.6)` | `rgba(0, 0, 0, 0.7)` | Account switch loading overlay bg |
...
:root {
  ...
  --color-switch-overlay: rgba(255, 255, 255, 0.6);
}
...
html.np-theme-dark {
  ...
  --color-forest-green: #163300;
  --color-sage-green: #CBD9C3;
  --color-switch-overlay: rgba(0, 0, 0, 0.7);
}
...
| `#9FE870` | `#9FE870` | Wise logo fill, bright green accent (camera badge, plus badge, promotion arrow) |
...
| `rgba(0, 0, 0, 0.6)` | same | Overlay scrims |
...
| Value | Usage |
|-------|-------|
| `#163300` | Business nav bar bg, forest green brand color |
