...
1. **Icon + color consistency.** An account's icon and color on the Home card MUST be carried through to every subpage (account page avatar, currency page avatar, breadcrumb). Never substitute a different icon (e.g. Wise logo or Money icon) for the account's actual icon.
