...
export function Home({ onNavigate, onNavigateAccount, onNavigateCurrency, onNavigateGroupAccount, onNavigateGroupCurrency, onNavigateJarAccount, onNavigateJarCurrency, accountType = 'personal', onAddMoney, onSend, onSendWithCurrency, onSendAgain, onRequest, onPaymentLink, onAccountDetails, pendingJointInviteName, hasIncomingInvite, jointAccountAccepted, onNavigateGetMore, onNavigateJointWaiting, onReviewIncomingInvite }: { onNavigate?: (page: string) => void; onNavigateAccount?: () => void; onNavigateCurrency?: (code: string) => void; onNavigateGroupAccount?: () => void; onNavigateGroupCurrency?: (code: string) => void; onNavigateJarAccount?: (jarId: string) => void; onNavigateJarCurrency?: (jarId: string, code: string) => void; accountType?: AccountType; onAddMoney?: () => void; onSend?: () => void; onSendWithCurrency?: (sourceCurrency: string, targetCurrency: string, sourceAmount?: string, targetAmount?: string) => void; onSendAgain?: (recipient: SendAgainRecipient, amount?: string) => void; onRequest?: () => void; onPaymentLink?: () => void; onAccountDetails?: () => void; pendingJointInviteName?: string | null; hasIncomingInvite?: boolean; jointAccountAccepted?: boolean; onNavigateGetMore?: () => void; onNavigateJointWaiting?: () => void; onReviewIncomingInvite?: () => void }) {
          ...
          {[
            hasIncomingInvite && (
              <TaskCard
                ...
                description="Review the invitation and accept or decline"
            ...
            pendingJointInviteName && (
              <TaskCard
                ...
                actionLabel={t('common.review')}
                onClick={onNavigateJointWaiting}
              />
            ),
            <TaskCard
              key="paused"
